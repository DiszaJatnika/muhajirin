	...
	6: [function (t, e, i) {
		! function (t, n) {
			...
			function c(t) {
				if (null == t._isValid) {
					var e = u(t),
						i = hn.call(e.parsedDateParts, function (t) {
							return null != t
						});
			...
			function m(t, e) {
				var i, n, a;
				if (g(e._isAMomentObject) || (t._isAMomentObject = e._isAMomentObject), g(e._i) || (t._i = e._i), g(e._f) || (t._f = e._f), g(e._l) || (t._l = e._l), g(e._strict) || (t._strict = e._strict), g(e._tzm) || (t._tzm = e._tzm), g(e._isUTC) || (t._isUTC = e._isUTC), g(e._offset) || (t._offset = e._offset), g(e._pf) || (t._pf = u(e)), g(e._locale) || (t._locale = e._locale), dn.length > 0)
					for (i in dn) n = dn[i], a = e[n], g(a) || (t[n] = a);
				return t
			}
			...
			function rt(t, e, i) {
				...
				if (!this._monthsParse)
					for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], n = 0; 12 > n; ++n) o = h([2e3, n]), this._shortMonthsParse[n] = this.monthsShort(o, "").toLocaleLowerCase(), this._longMonthsParse[n] = this.months(o, "").toLocaleLowerCase();
		...
		e.exports = function (t) {
			...
			t.defaults.bar = {
				...
				updateElement: function (t, i, n) {
					var a = this.getMeta(),
						o = this.getScaleForId(a.xAxisID),
				...
				getRuler: function (t) {
					...
					var o = e * n.options.categoryPercentage,
						r = (e - e * n.options.categoryPercentage) / 2,
						s = o / a;
					if (n.ticks.length !== this.chart.data.labels.length) {
						var l = n.ticks.length / this.chart.data.labels.length;
						s *= l
					}
					var h = s * n.options.barPercentage,
				...
				calculateBarX: function (t, e) {
					var i = this.getMeta(),
						...
						o = this.getRuler(t),
						r = n.getPixelForValue(null, t, e, this.chart.isCombo);
			...
			i.doughnut = {
						...
						generateLabels: function (t) {
							...
							return i.labels.length && i.datasets.length ? i.labels.map(function (n, a) {
								var o = t.getDatasetMeta(0),
									...
									u = l.backgroundColor ? l.backgroundColor : h(r.backgroundColor, a, d.backgroundColor),
									c = l.borderColor ? l.borderColor : h(r.borderColor, a, d.borderColor),
									f = l.borderWidth ? l.borderWidth : h(r.borderWidth, a, d.borderWidth);
								return {
									text: n,
									fillStyle: u,
									strokeStyle: c,
				...
				update: function (t) {
					...
					if (f < 2 * Math.PI) {
						...
						var m = g + f,
							...
							v = 0 >= g && m >= 0 || g <= 2 * Math.PI && 2 * Math.PI <= m,
				...
				updateElement: function (t, i, n) {
					var a = this,
						...
						f = s.rotation,
						g = a.getDataset(),
						m = n && l.animateRotate ? 0 : t.hidden ? 0 : a.calculateCircumference(g.data[i]) * (s.circumference / (2 * Math.PI)),
						p = n && l.animateScale ? 0 : a.innerRadius,
						b = n && l.animateScale ? 0 : a.outerRadius,
						v = t.custom || {},
						y = e.getValueAtIndexOrDefault;
					e.extend(t, {
		...
		e.exports = function (t) {
			...
			t.defaults.polarArea = {
				...
				updateElement: function (t, i, n) {
					...
					var k = t.hidden ? 0 : c.getDistanceFromCenterForValue(s.data[i]),
						_ = -.5 * Math.PI + m * v,
						S = _ + (t.hidden ? 0 : m),
						w = {
							x: p,
			...
			t.defaults.radar = {
				...
				updateElement: function (t, i, n) {
					var a = t.custom || {},
						...
						l = r.getPointPositionForValue(i, o.data[i]);
					e.extend(t, {
						_datasetIndex: this.index,
						_index: i,
						_scale: r,
			...
			t.types = {}, t.instances = {}, t.controllers = {}, t.Controller = function (i) {
				...
				resize: function (t) {
					var i = this.chart.canvas,
						n = e.getMaximumWidth(this.chart.canvas),
						a = this.options.maintainAspectRatio && isNaN(this.chart.aspectRatio) === !1 && isFinite(this.chart.aspectRatio) && 0 !== this.chart.aspectRatio ? n / this.chart.aspectRatio : e.getMaximumHeight(this.chart.canvas),
						o = this.chart.width !== n || this.chart.height !== a;
				...
				buildScales: function () {
					...
					n.scales && (o = o.concat((n.scales.xAxes || []).map(function (t) {
						...
						var r = n.options,
							s = e.getValueOrDefault(r.type, n.dtype),
			...
			t.elements = {}, t.Element = function (t) {
				...
				transition: function (t) {
					return this._view || (this._view = e.clone(this._model)), 1 === t ? (this._view = this._model, this._start = null, this) : (this._start || this.pivot(), e.each(this._model, function (i, n) {
						if ("_" === n[0]);
						else if (this._view.hasOwnProperty(n))
							if (i === this._view[n]);
						...
						else "number" != typeof i || isNaN(this._view[n]) ? this._view[n] = i : this._view[n] = i * t
					}, this), this)
				},
	...
	25: [function (t, e, i) {
		...
		e.exports = function (t) {
			...
			o.each = function (t, e, i, n) {
				...
				var n = -1;
				if (Array.prototype.findIndex) n = t.findIndex(e, i);
				else
					for (var a = 0; a < t.length; ++a)
						if (i = void 0 !== i ? i : t, e.call(i, t[a], a, t)) {
							n = a;
							break
						} return n
			...
			o.requestAnimFrame = function () {
				...
				var h = parseFloat(o.getStyle(r, "padding-left")),
					d = parseFloat(o.getStyle(r, "padding-top")),
					u = parseFloat(o.getStyle(r, "padding-right")),
					c = parseFloat(o.getStyle(r, "padding-bottom")),
					f = s.right - s.left - h - u,
				...
				update: function (t, i, n) {
					...
					if (t) {
						...
						var m = i - 2 * l,
							...
							b = m / 2,
							v = p / 2,
							y = (i - b) / (d.length + u.length),
							x = (n - v) / (c.length + f.length),
							k = m,
							_ = p,
							S = [];
			...
			t.defaults.global.legend = {
				...
				fit: function () {
					var i = this.options,
						...
						l = s(n.fontSize, r.defaultFontSize),
						h = s(n.fontStyle, r.defaultFontStyle),
						d = s(n.fontFamily, r.defaultFontFamily),
						u = e.fontString(l, h, d),
					...
					if (g ? (f.width = this.maxWidth, f.height = a ? 10 : 0) : (f.width = a ? 10 : 0, f.height = this.maxHeight), a && g) {
						var m = this.lineWidths = [0],
							p = this.legendItems.length ? l + n.padding : 0;
				...
				draw: function () {
					...
					if (i.display) {
						var l = this.ctx,
							...
							u = d(n.fontColor, a.defaultFontColor),
							c = d(n.fontSize, a.defaultFontSize),
							f = d(n.fontStyle, a.defaultFontStyle),
							g = d(n.fontFamily, a.defaultFontFamily),
							m = e.fontString(c, f, g);
				...
				handleEvent: function (t) {
					var i = e.getRelativePosition(t, this.chart.chart),
						...
						a = i.y,
						o = this.options;
					if (n >= this.left && n <= this.right && a >= this.top && a <= this.bottom)
	...
	29: [function (t, e, i) {
		...
		e.exports = function (t) {
			...
			t.plugins = [], t.pluginService = {
				...
				remove: function (e) {
					var i = t.plugins,
						n = i.indexOf(e); - 1 !== n && i.splice(n, 1)
				},
			...
			t.defaults.scale = {
				...
				calculateTickRotation: function () {
					var i = this.ctx,
						...
						r = e.getValueOrDefault(a.fontStyle, n.defaultFontStyle),
						s = e.getValueOrDefault(a.fontFamily, n.defaultFontFamily),
						l = e.fontString(o, r, s);
					i.font = l;
					var h, d = i.measureText(this.ticks[0]).width,
						u = i.measureText(this.ticks[this.ticks.length - 1]).width;
				...
				fit: function () {
					var i = this.minSize = {
						...
						s = n.display,
						l = this.isHorizontal(),
						h = e.getValueOrDefault(o.fontSize, a.defaultFontSize),
						d = e.getValueOrDefault(o.fontStyle, a.defaultFontStyle),
						u = e.getValueOrDefault(o.fontFamily, a.defaultFontFamily),
						c = e.fontString(h, d, u),
						f = e.getValueOrDefault(r.fontSize, a.defaultFontSize),
						g = e.getValueOrDefault(r.fontStyle, a.defaultFontStyle),
						m = e.getValueOrDefault(r.fontFamily, a.defaultFontFamily),
						p = (e.fontString(f, g, m), n.gridLines.tickMarkLength);
					if (l ? i.width = this.isFullWidth() ? this.maxWidth - this.margins.left - this.margins.right : this.maxWidth : i.width = s ? p : 0, l ? i.height = s ? p : 0 : i.height = this.maxHeight, r.display && s && (l ? i.height += 1.5 * f : i.width += 1.5 * f), o.display && s) {
						...
						if (l) {
							...
							var y = this.ctx.measureText(this.ticks[0]).width,
				...
				draw: function (i) {
					...
					if (n.display) {
						...
						var p = e.getValueOrDefault(u.fontColor, d.defaultFontColor),
							b = e.getValueOrDefault(u.fontSize, d.defaultFontSize),
							v = e.getValueOrDefault(u.fontStyle, d.defaultFontStyle),
							y = e.getValueOrDefault(u.fontFamily, d.defaultFontFamily),
							x = e.fontString(b, v, y),
							k = c.tickMarkLength,
							_ = e.getValueOrDefault(f.fontColor, d.defaultFontColor),
							S = e.getValueOrDefault(f.fontSize, d.defaultFontSize),
							w = e.getValueOrDefault(f.fontStyle, d.defaultFontStyle),
							M = e.getValueOrDefault(f.fontFamily, d.defaultFontFamily),
							C = e.fontString(S, w, M),
							D = e.toRadians(this.labelRotation),
							T = Math.cos(D),
							P = (Math.sin(D), this.longestLabelWidth * T);
						if (h.fillStyle = p, this.isHorizontal()) {
							a = !0;
							var A = "bottom" === n.position ? this.top : this.bottom - k,
								F = "bottom" === n.position ? this.top + k : this.bottom;
							if (o = !1, g && (P /= 2), (P + u.autoSkipPadding) * this.ticks.length > this.width - (this.paddingLeft + this.paddingRight) && (o = 1 + Math.floor((P + u.autoSkipPadding) * this.ticks.length / (this.width - (this.paddingLeft + this.paddingRight)))), l && this.ticks.length > l)
								for (; !o || this.ticks.length / (o || 1) > l;) o || (o = 1), o += 1;
							m || (o = !1), e.each(this.ticks, function (t, r) {
								var s = this.ticks.length === r + 1,
									l = o > 1 && r % o > 0 || r % o === 0 && r + o >= this.ticks.length;
								if ((!l || s) && void 0 !== t && null !== t) {
									var d = this.getPixelForTick(r),
										f = this.getPixelForTick(r, c.offsetGridLines);
							...
							a = !0;
							var I = "right" === n.position ? this.left : this.right - 5,
								O = "right" === n.position ? this.left + 5 : this.right;
			...
			t.Title = t.Element.extend({
				...
				draw: function () {
					var i = this,
						...
						r = t.defaults.global;
					if (o.display) {
						var s, l, h = a(o.fontSize, r.defaultFontSize),
							d = a(o.fontStyle, r.defaultFontStyle),
							u = a(o.fontFamily, r.defaultFontFamily),
							c = e.fontString(h, d, u),
							f = 0,
							g = i.top,
							m = i.left,
			...
			t.defaults.global.elements.line = {
				...
				draw: function () {
					...
					o.save(), this._children.length > 0 && a.fill && (o.beginPath(), e.each(this._children, function (t, i) {
						var n = e.previousItem(this._children, i),
				...
				n = t.Scale.extend({
					...
					getValueForPixel: function (t) {
						var e, i = Math.max(this.ticks.length - (this.options.gridLines.offsetGridLines ? 0 : 1), 1),
							n = this.isHorizontal(),
							a = n ? this.width - (this.paddingLeft + this.paddingRight) : this.height - (this.paddingTop + this.paddingBottom),
							o = a / i;
				...
				n = t.Scale.extend({
					...
					buildTicks: function () {
						var i, n = this,
							...
							s = n.isHorizontal(),
							l = n.ticks = [];
						if (s) i = Math.min(o.maxTicksLimit ? o.maxTicksLimit : 11, Math.ceil(n.width / 50));
						else {
						...
						if (u) d = r(o.fixedStepSize, o.stepSize);
						else {
							var c = e.niceNum(n.max - n.min, !1);
							d = e.niceNum(c / (i - 1), !0)
						}
						var f = Math.floor(n.min / d) * d,
							g = Math.ceil(n.max / d) * d,
							m = (g - f) / d;
			...
			var e = t.helpers,
				...
				a = t.Scale.extend({
					...
					setDimensions: function () {
						...
						var n = e.min([this.height, this.width]),
							a = e.getValueOrDefault(t.ticks.fontSize, i.defaultFontSize);
					...
					buildTicks: function () {
						...
						var t = e.getValueOrDefault(this.options.ticks.fontSize, i.defaultFontSize),
							n = Math.min(this.options.ticks.maxTicksLimit ? this.options.ticks.maxTicksLimit : 11, Math.ceil(this.drawingArea / (1.5 * t)));
						n = Math.max(2, n);
						var a = e.niceNum(this.max - this.min, !1),
							o = e.niceNum(a / (n - 1), !0),
							r = Math.floor(this.min / o) * o,
					...
					fit: function () {
						var t, n, a, o, r, s, l, h, d, u, c, f, g = this.options.pointLabels,
							m = e.getValueOrDefault(g.fontSize, i.defaultFontSize),
							p = e.getValueOrDefault(g.fontStyle, i.defaultFontStyle),
							b = e.getValueOrDefault(g.fontFamily, i.defaultFontFamily),
							v = e.fontString(m, p, b),
						...
						if (this.options.display) {
							...
							if (e.each(this.ticks, function (n, a) {
									if (a > 0 || this.options.reverse) {
										...
										if (this.options.gridLines.display)
											...
											var h = e.getValueOrDefault(this.options.ticks.fontColor, i.defaultFontColor),
												...
												u = e.getValueOrDefault(this.options.ticks.fontStyle, i.defaultFontStyle),
												c = e.getValueOrDefault(this.options.ticks.fontFamily, i.defaultFontFamily),
												f = e.fontString(d, u, c);
								...
								for (var n = this.getValueCount() - 1; n >= 0; n--) {
									...
									var o = this.getPointPosition(n, this.getDistanceFromCenterForValue(this.options.reverse ? this.min : this.max) + 5),
				...
				o = t.Scale.extend({
					...
					determineDataLimits: function () {
						...
						this.chart.data.labels && this.chart.data.labels.length > 0 ? (e.each(this.chart.data.labels, function (e, i) {
							...
							var o = [],
								r = this.chart.isDatasetVisible(a);
					...
					getPixelForValue: function (t, e, i, n) {
						...
						if (a) {
							var o = a.diff(this.firstTick, this.tickUnit, !0),
								r = o / this.scaleSizeInUnits;
							if (this.isHorizontal()) {
								var s = this.width - (this.paddingLeft + this.paddingRight),
									l = (s / Math.max(this.ticks.length - 1, 1),
