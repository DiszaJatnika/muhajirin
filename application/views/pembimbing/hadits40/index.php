	...
	<div class="x_panel">
		<div class="x_title">
			...
			<ul class="nav navbar-right panel_toolbox">
				<li>
					<a href="<?= base_url("Hadits-40-tambah-data");?>">
							...
							<tbody>	
								...
								<tr>
									...
									<td class="text-center">
										<a href="<?= base_url('Hadits-40-edit/'.encrypt_url($m['hadits40_id'])) ?>">
											<i class="fa fa-pencil btn btn-warning"></i>
										</a>
										<a href="<?= base_url('Hadits-40-hapus/'.encrypt_url($m['hadits40_id'])) ?>" onclick="return confirm('Anda Yakin Ingin Menghapus?'+ '<?=   '&nbsp;'.$m['nama_siswa']; ?>')">
