<div class="col-md-12 col-sm-12 ">
	<div class="x_panel">
		<div class="x_title">
			<h2>Data Hadits 300</h2>
			<ul class="nav navbar-right panel_toolbox">
				<li>
					<a href="<?= base_url("Hadits-300-tambah-data");?>">
							...
							<tbody>	
								...
								<tr>
									...
									<td class="text-center">
										<a href="<?= base_url('Hadits-40-edit/'.encrypt_url($m['hadits300_id'])) ?>">
											<i class="fa fa-pencil btn btn-warning"></i>
										</a>
										<a href="<?= base_url('Hadits-40-hapus/'.encrypt_url($m['hadits300_id'])) ?>" onclick="return confirm('Anda Yakin Ingin Menghapus?'+ '<?=   '&nbsp;'.$m['nama_siswa']; ?>')">
