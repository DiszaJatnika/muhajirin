...
<div class="row">
	<div class="col-md-12 col-sm-12 ">
		<div class="x_panel">
			...
			<div class="x_content">
				<br />
				<form method="POST" action="<?= base_url('Hadits-40-edit-save'); ?>" data-parsley-validate
					class="form-horizontal form-label-left">
                    <input type="hidden" name="hadits40_id" id="hadits40_id" value="<?= encrypt_url($dthadits['hadits40_id'])?>">
					...
					<div class="item form-group">
						...
						<div class="col-md-4 col-sm-4 ">
							<select name="hadits_id" id="hadits_id" class="form-control" >
                                    <option>Pilih</option>
									<?php foreach ($hadits as $m) : ?>
										<option value="<?= $m['hadits_id']?>" <?php if($m['hadits_id'] == $dthadits['hadits_id']){ echo"selected";} ?>><?= $m['nama_hadits']?></option>
									<?php endforeach; ?>
							</select>
						</div>
					</div>
					...
					<div class="item form-group">
						...
						<div class="col-md-4 col-sm-4 ">
							<input type="radio" name="putaran" id="putaran" value="1" <?php if($dthadits['hadits_id'] == '1'){ echo"checked";} ?>> Satu
							<input type="radio" name="putaran" id="putaran" value="2" <?php if($dthadits['hadits_id'] == '2'){ echo"checked";} ?>> Dua
							<input type="radio" name="putaran" id="putaran" value="3" <?php if($dthadits['hadits_id'] == '3'){ echo"checked";} ?>> Tiga
						</div>
					</div>
					...
					<div class="item form-group">
						...
						<div class="col-md-4 col-sm-4 ">
							<textarea name="keterangan" id="keterangan" cols="30" rows="5" class="form-control"><?= $dthadits['keterangan']?></textarea>
						</div>
					</div>
