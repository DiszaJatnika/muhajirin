...
<div class="row">
	<div class="col-md-12 col-sm-12 ">
		<div class="x_panel">
			...
			<div class="x_content">
				<br />
				<form method="POST" action="<?= base_url('Murojaah-save'); ?>" data-parsley-validate
						...
						<div class="col-md-4 col-sm-4 ">
							<select name="dari_surah" id="dari_surah" class="form-control select2" >
									<?php foreach ($quran as $m => $value) : ?>
										<option value="<?= $value['nama_latin']?>"><?= $value['nama_latin']?></option>
									<?php endforeach; ?>
							</select>
						</div>
					</div>
					<div class="item form-group">
						...
						<div class="col-md-4 col-sm-4 ">
							<input type="text" name="dari_ayat_ke" id="dari_ayat_ke" class="form-control">
						</div>
					</div>
					<div class="item form-group">
						<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">
					...
					<div class="item form-group">
						...
						<div class="col-md-4 col-sm-4 ">
							<input type="text" name="sampai_ayat_ke" id="sampai_ayat_ke" class="form-control">
						</div>
					</div>
