...
<div class="row">
	<div class="col-md-12 col-sm-12 ">
		<div class="x_panel">
			...
			<div class="x_content">
				<br />
				<form method="POST" action="<?= base_url('Master-hadits40-edit-save'); ?>" data-parsley-validate
					class="form-horizontal form-label-left">
                    <input type="hidden" name="hadits_id" id="hadits_id" value="<?= encrypt_url($hadits['hadits_id'])?>">
					<div class="item form-group">
						<label class="col-form-label col-md-3 col-sm-3 label-align" for="last-name">Nama Hadits
							<span></span>
						</label>
						<div class="col-md-6 col-sm-6 ">
							<input type="text" id="nama_hadits" name="nama_hadits" value="<?= $hadits['nama_hadits'] ?>" required="required" class="form-control">
						</div>
					</div>
                    <div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input type="text" id="isi" name="isi" value="<?= $hadits['isi'] ?>"  required="required" class="form-control">
						</div>
					</div>
